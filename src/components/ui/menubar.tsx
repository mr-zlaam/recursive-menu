...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex h-9 items-center space-x-1 rounded-md text-background p-1",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <>
    <MenubarPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex cursor-pointer select-none gap-2 items-center rounded-sm  py-1 text-sm font-medium outline-none ",
        className,
      )}
      {...props}
    />
    <ChevronDown size={16} className="relative right-1  top-0 cursor-pointer" />
  </>
));
...
>(({ className, inset, ...props }, ref) => (
  <MenubarPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none hover:bg-accent  data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      inset && "pl-8",
      className,
    )}
    {...props}
